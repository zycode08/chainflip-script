...
echo -e "\e[1m\e[32m    Enter sign key:\e[0m"
echo "_|-_|-_|-_|-_|-_|-_|"
read sign_key
echo "_|-_|-_|-_|-_|-_|-_|"

echo -e "\e[1m\e[32m    Enter node key:\e[0m"
echo "_|-_|-_|-_|-_|-_|-_|"
read node_key
echo "_|-_|-_|-_|-_|-_|-_|"
...
echo "======== Signing Key ========" >> keys.txt
SECRET_SEED=$sign_key
echo -n "${SECRET_SEED:2}" | sudo tee /etc/chainflip/keys/signing_key_file

echo "======== Node Key ========" >> keys.txt
echo -n "$node_key" | sudo tee /etc/chainflip/keys/node_key_file
